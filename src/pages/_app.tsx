    ...
    <Provider store={store}>
      <QueryParamProvider adapter={NextAdapterApp}>
        <MantineProvider theme={theme}>
          ...
          {asPath === '/' &&
            <div style={{
              background: `linear-gradient(0deg, rgb(255,215,110), rgba(0, 0, 0, 0.5)), url('/footer.webp')`,
              ...
              <div className='right-0 left-0 w-[70%] m-auto text-center absolute top-[150px] lg:top-[200px]'>
                <h3 className='font-bold mb-4 text-[25px]'>BECOME AN INSTRUCTOR?</h3>
                <p className='mb-4 text-[18px]'>Join thousand of instructors and earn money hassle free!</p>
