    ...
    <div
      ...
      <div className='relative md:w-[90]'>
        <div className='group overflow-hidden '>
          <Image
            ...
            src={image}
            alt=''
            className='h-[190px] m-auto cursor-pointer transition-transform transform group-hover:brightness-75 hover:-translate-y-1 hover:scale-110 duration-500 ease-in-out'
          />
          <MoreButton
            classes={'absolute top-[70px] left-[65px] hidden group-hover:block'}
            to={'/courses'}
            label={'Read more'}
          />
        </div>
      ...
      <div className='p-3 absolute md:w-[90] bottom-0 w-full '>
        <div className='boder border-black w-full relative'>
          <Minus
            color='#FFB606'
            className='block m-auto top-[-11.5px] left-0 right-0 absolute'
          />
        </div>
