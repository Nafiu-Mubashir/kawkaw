...
const CoursesCard = ({ authur, title, price, image, members, classes, amount }: CardProp) => {
  ...
  return (
    <div className={`relative shadow-md w-full md:w-[350px] lg:w-[300px] h-[500px] overflow-hidden ${classes}`}>
      <div className='relative'>
        <div className='group'>
          ...
          <MoreButton classes={'absolute px-2 py-1 top-[120px] left-[65px] hidden group-hover:block'} to={'/courses'} label={'Read more'} />
        </div>
