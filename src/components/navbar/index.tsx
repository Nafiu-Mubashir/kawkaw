...
export const Navabr = ({ position }: { position: string }) => {
  ...
  return (
    <nav
      className={`main-na ${
        isNavbarWhite
          ? 'bg-white transition duration-600 delay-75 ease-in transform text-black fixed w-full z-10 top-0'
          : `bg-transparent transition duration-500 delay-75 ease-out transform text-white ${position} w-full z-10 top-0`
      }`}
      ref={navbarRef}>
        ...
        <div className='flex justify-between mx-auto w-full lg:w-[90%] px-2 sm:px-6 lg:px-8'>
          <div className='flex justify-between items-center gap-5'>
            ...
            <p className='flex items-center gap-2'>
              ...
              <span className='hidden md:hidden lg:block'>(+88) 1990 6886</span>
            </p>
            <p className='flex items-center gap-2'>
            ...
            <p className='flex items-center gap-2'>
              ...
              <span className='hidden md:hidden lg:block'>Demo account</span>
            </p>
          </div>
          <div>
            <Registration /> | <Login />
